		...
		function f_postload_MARQUE(row,col){
		    ...
		    Plugin.prototype = {
		        ...
		        **********************************************************/
		        defaults: {
		            ...
		            pagerClass: "es-pager",
		            pagerImage: "EAFormBlob.sp?guid=1AE71509AC88C91BE050007F01003525"
		        },
		            ...
		            if (base.config.pagerNav)
		            {
		                ...
		                $children.each(function () {
		                    $("<li />").appendTo($("." + base.config.pagerClass, base.$elem))
		                        .attr("rel", $(this).index())
		                        .css({ "background-image": "url('" +G_WEBBASE+base.config.pagerImage + "')" })
		                        .on("click", function () {
